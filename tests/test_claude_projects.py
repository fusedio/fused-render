"""Extra Fused workspaces discovered from Claude Code's project list (D214).
...
def test_a_root_inside_the_claude_science_store_is_refused(tmp_path, config,
    ...
    claude_split — the version-stacked read-only path D212 special-cases the
...
def test_a_source_switched_off_is_not_listed_and_is_not_walked(
    ...
    """Preferences → App discovery (D216).
