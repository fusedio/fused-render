...
class DesktopPaths:
    ...
    def child_environment(
        ...
        env = {
            ...
            # sessions.zip ships in the payload's assets/ (the Windows
            # installer globs assets\*); mounts.builtin_zip_path() reads this
            # override, and its isfile check no-ops when a build didn't bundle
            # a zip.
