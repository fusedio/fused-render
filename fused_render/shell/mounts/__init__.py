...
from .lifecycle import (
    ...
    _QUIT_TEARDOWN_LATCH,
    _QUIT_UNMOUNT_BUDGET_S,
    _QUIT_UNMOUNT_JOIN_BUDGET_S,
    _UNSET,
    _attach_in_flight,
    _await_attaches_settled,
    _await_ismount,
    _force_unmount,
    _is_mounted,
...
from .automount import (
    BUILTIN_MOUNTS,
    COMMUNITY_MOUNT_NAME,
    LEARN_MOUNT_NAME,
    SESSIONS_MOUNT_NAME,
    _force_detach_builtin_mount,
    builtin_mount_ready,
    builtin_zip_path,
    community_mount_ready,
