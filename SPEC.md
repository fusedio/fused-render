...
- **SR-12** **A search selects its TOP HIT**, so the preview pane has something in
  ...
  removal of the folder auto-select (FS-16, D277) and is now the listing's only
