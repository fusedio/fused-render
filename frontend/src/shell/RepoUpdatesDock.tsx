...
export function RepoUpdatesDockView({
   ...
   *  the reason DownloadManager.tsx documents for `cancelFn`/`dismissFn`: a
   ...
   *  than depend on whatever the fresh-profile default happens to be — which is
   *  exactly what changed under them in D595. */
