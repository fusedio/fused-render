...
- **PF-1c** **The Hugging Face section is on this page and is NOT a preference**
  (D384). It is a **Log in to Hugging Face** button, it talks to `/api/hf/*`
...
- **HS-0d** **The constraint is "an engine here can run it", NOT "nothing
  ...
  this does not add one** — *narrowed by D384*: Preferences has a **Log in to
...
- **AI-5i** **The weights are fetched on several connections, and an interrupted
  ...
  the worker's environment, §20/PF-1f, D384) — up to
