...
.html file (rendered in an iframe)
   ...
   │
   ├─ fused.ai.text("...")     ← the claude CLI, or a local model; {text, model, usage, provider}
   │
