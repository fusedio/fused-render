...
// models loaded` / `Idle` / `Up to date`) — plain, muted text with no
// chevron, since there is no panel behind an idle section worth opening —
// rather than an empty box shouting for attention.
//
