...
import { publishChatRecapEnabled } from "@apps/claude/chat-prefs";
...
// Chat: the settings of the app's Claude chat. One checkbox today — the session
// recap — in the same one-checkbox section shape as Canvases above.
...
// section shape as Chat above — and no `forced_by`, because this switch has no
// env override to be beaten by (prefs.py `task_peek_enabled` says why).
