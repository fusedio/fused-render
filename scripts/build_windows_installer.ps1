...
Invoke-Native $bundlePython @(
    "-I", "-c",
    "import duckdb, fused_render, fused_render.cli, fused_render.win_supervisor.supervisor, win32job, win32pipe, win32security, win32event, win32process, pystray, cryptography; print('bundle imports ok')"
)
