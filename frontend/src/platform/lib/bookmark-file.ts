...
import { rootedFsPath, urlForFsPath, VIEW_PREFIX, EMBED_PREFIX } from "@platform/lib/router";
import {
  splitShellSearch,
  parseLayout,
  flattenToLeaves,
...
import { sanitizeBookmarkStem, type Bookmark } from "@platform/lib/bookmarks";
